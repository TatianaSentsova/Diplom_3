...
class TestUserAccount:
    ...
    def test_open_user_account(self, driver, landing_page, login_page, user_account_page, authorized_user):
        landing_page.click_sign_in_button()
        login_page.login_user(authorized_user.email, authorized_user.password)
        landing_page.wait_make_order_page()
        landing_page.click_user_account_button()
    ...
    def test_open_order_history(self, driver, landing_page, login_page, user_account_page, authorized_user):
        landing_page.click_sign_in_button()
        login_page.login_user(authorized_user.email, authorized_user.password)
        landing_page.wait_make_order_page()
        landing_page.click_user_account_button()
    ...
    def test_logout(self, driver, landing_page, login_page, user_account_page, authorized_user):
        landing_page.click_sign_in_button()
        login_page.login_user(authorized_user.email, authorized_user.password)
        landing_page.wait_make_order_page()
        landing_page.click_user_account_button()
